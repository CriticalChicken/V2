...
<ul>
<li>We&rsquo;ve been online for <span class="timetip vital-timetip" title="11th June 2016 - launch of Critical Chicken"><?php echo do_shortcode('[DateCounter startDate="2016-06-11" endDate="now" format="%y years, %m months, and %d days"]'); ?></span>. Here&rsquo;s <a href="https://www.criticalchicken.com/welcome-to-critical-chicken/" title="Welcome to Critical Chicken"><b>our first post</b></a>.</li>
<li>We&rsquo;ve written <b><?php echo do_shortcode('[sbs_posts]'); ?> posts</b> totalling <b><?php echo do_shortcode('[sbs_word_count_all]'); ?> words</b>.</li>
